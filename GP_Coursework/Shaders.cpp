...
void Shaders::initialise(const std::string& vertFile, const std::string& fragFile)
{
...
GLuint Shaders::CreateShader(const std::string& text, unsigned int type)
{
...
void Shaders::CheckShaderError(GLuint shader, GLuint flag, bool isProgram, const std::string& errorMessage)
{
	GLint success = 0;
	GLchar error[1024] = { 0 };
